          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
            <div className="col-span-1 md:col-span-1">
              <div className="flex items-center mb-6 h-8 cursor-pointer" onClick={() => navigate('/')}>
                <img src="/logo.png" alt="Capital Match Logo" className="h-[2.5rem] w-auto object-contain drop-shadow-[0_0_10px_rgba(255,255,255,0.1)] -ml-2" />
              </div>
              <p className="text-text-muted text-sm leading-relaxed mb-6 pe-4">
                The premier ecosystem for proprietary trading firms. Discovery, analytics, and verification powered by AI.
              </p>
              <div className="flex space-x-4">
                {/* Social icons */}
                <div className="w-8 h-8 rounded-full bg-white/5 hover:bg-white/10 flex items-center justify-center transition-colors cursor-pointer text-text-muted hover:text-white border border-white/5">
