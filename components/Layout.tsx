          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
            <div className="col-span-1 md:col-span-1">
              ...
              <div className="flex space-x-4">
                ...
                <a href="https://discord.gg/6MknbESVS6" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-white/5 hover:bg-[#5865F2]/20 flex items-center justify-center transition-all duration-300 hover:scale-110 cursor-pointer text-text-muted hover:text-[#5865F2] border border-white/5 hover:border-[#5865F2]/50 hover:shadow-[0_0_15px_rgba(88,101,242,0.3)]">
